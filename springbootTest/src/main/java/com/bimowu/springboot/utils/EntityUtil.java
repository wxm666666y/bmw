package com.bimowu.springboot.utils;
...
public class EntityUtil {
    ...
    private final String moduleName = "bmw_ssm"; // 数据库名称

    private final String bean_path = "D:\\IDEA-Workspace\\bmw\\springbootTest\\src\\main\\java";

    private final String mapper_path = "D:\\IDEA-Workspace\\bmw\\springbootTest\\src\\main\\java\\com\\bimowu\\springboot\\dao";

    private final String xml_path = "D:\\IDEA-Workspace\\bmw\\springbootTest\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.bimowu.springboot.model";// model的包所在

    private final String dao_package = "com.bimowu.springboot.dao";// dao的包所在

    private final String driverName = "com.mysql.cj.jdbc.Driver";

    private final String user = "root";// 数据库用户

    private final String password = "wxm147369";// "root";//数据库密码
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.bimowu.springboot.utils.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
    ...
    private void buildSQL(BufferedWriter bw, List<String> columns, List<String> types)
            throws IOException {
