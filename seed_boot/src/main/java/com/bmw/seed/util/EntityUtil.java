...
public class EntityUtil {
	...
	private final String moduleName = "pro"; // 数据库名称

	private final String bean_path = "C:\\develop\\bmwSpace2\\search-boot\\src\\main\\java";

	private final String mapper_path = "C:\\develop\\bmwSpace2\\search-boot\\src\\main\\java\\com\\bmw\\search\\dao";

	private final String xml_path = "C:\\develop\\bmwSpace2\\search-boot\\src\\main\\resources\\mapping";// xml路径

	private final String model_package = "com.bmw.search.model";// model的包所在

	private final String dao_package = "com.bmw.search.dao";// dao的包所在
