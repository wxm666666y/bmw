...
public class EntityUtil {
    ...
    private final String bean_path = "D:\\IDEA-Workspace\\bmw\\reptile\\src\\main\\java";

    private final String mapper_path = "D:\\IDEA-Workspace\\bmw\\reptile\\src\\main\\java\\com\\bmw\\reptile\\dao";

    private final String xml_path = "D:\\IDEA-Workspace\\bmw\\reptile\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.bmw.reptile.model";// model的包所在

    private final String dao_package = "com.bmw.reptile.dao";// dao的包所在
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.bmw.reptile.utils.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
